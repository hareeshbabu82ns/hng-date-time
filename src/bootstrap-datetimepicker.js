    ...
    DateTimePicker.prototype = {
        ...
        formatDate: function (d) {
            ...
            return this.format.replace(formatReplacer, function (match) {
                ...
                } else if (property === 'MonthShort') {
                    rv = d.getUTCMonth();
                    rv = dates[self.language].monthsShort[rv];
                } else if (property === 'Month') {
                    rv = d.getUTCMonth();
                    rv = dates[self.language].months[rv];
                } else if (property === 'Day') {
                    rv = d.getUTCDate();
                    rv = dates[self.language].days[rv];
                } else if (property === 'DayShort') {
                    rv = d.getUTCDay();
                    rv = dates[self.language].daysShort[rv];
                } else if (property === 'DayMin') {
                    rv = d.getUTCDay();
                    rv = dates[self.language].daysMin[rv];
                } else {
            ...
            if (this.pickDate && this.pickTime) {
                this.widget.on('click.togglePicker', '.accordion-toggle', function (e) {
                    ...
                    if (expanded && expanded.length) {
                        ...
                        closed.collapse('show').addClass('collapse');
